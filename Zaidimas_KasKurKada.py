...
thank_you_ru2 = ['Пожалуйста.' , 'Нет проблем', 'He беспокойтесь', 'C удовольствием' , 'Это меньшее, что я мог сделать', 'Рад помочь']
...
def menu_ru(update: Update, context: CallbackContext):
    ...
    if(user_response == 'игра'):
        ...
        def ka(update: Update, context: CallbackContext)-> int:
            ...
            a = ('в Африке', 'в Северном полюсе', 'в самой большой в мире заднице', 'лутше не спрашивайте где', 'в Никарагуа', 'в дереве с назбаниям Пабездунай', 'в Пикачу королевстве', 'в хижине старой ведьмы', 'в гостях у Талибан', 'в аду', 'в навозной яме', 'на съемочной площадке', 'на свалке старых бритв', 'в синием ките')
            global Kur
            Kur = random.choice(a)
            ...
            update.message.reply_text(Kada.capitalize() + " " + Kur + " " + Kas + " " + Su_kuo + " " + Ka_veikia + " " + Ka + ".")
